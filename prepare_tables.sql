...
/*
TO DO 12/15
Create dummy excel files to match insert statements
Find Schema Visualization Tool
Make sure to mention the requirements and why we aren't just handling this with data types and hard stop errors
*/
